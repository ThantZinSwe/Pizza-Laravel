              ...
              <div class="card">
                ...
                <div class="card-body">
                    <div class="text-center my-3">
                        <img src='{{ asset('uploads/'.$pizza->image) }}' class="img-thumbnail rounded-circle" width="150px">
                    </div>
                      ...
                      <form class="form-horizontal" action="{{ route('admin#updatePizza',$pizza->pizza_id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <select name="publishStatus" class="form-control">
                                  <option value="1" {{ old('publishStatus',$pizza->publish_status)=='1'?'selected':'' }}>Publish</option>
                                  <option value="0" {{ old('publishStatus',$pizza->publish_status)=='0'?'selected':'' }}>Unpublish</option>
                              </select>
                            ...
                            <div class="col-sm-9">
                                <select name="categoryId" class="form-control">
                                    @foreach ($category as $items)
                                         <option value="{{ $items->category_id }}" {{ old('categoryId',$pizza->category_id)== $items->category_id ? 'selected':'' }}>{{ $items->category_name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <input type="radio" name="buyOneGetOne" class="form-input-check" value="1" {{ old('buyOneGetOne',$pizza->buy_one_get_one_status)=='1'?'checked':'' }}> Yes
                                <input type="radio" name="buyOneGetOne" class="form-input-check" value="0" {{ old('buyOneGetOne',$pizza->buy_one_get_one_status)=='0'?'checked':'' }}> No
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <textarea name="description" id="" cols="30" rows="5" class="form-control" placeholder="Description">{{ old('description',$pizza->description) }}</textarea>
